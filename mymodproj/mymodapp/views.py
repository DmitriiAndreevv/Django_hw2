...
def index(request):
    return render(request, "mymodapp/index.html")
...
def basket(request, user_id):
    ...
    products.reverse()
    return render(request, 'mymodapp/user_all_orders.html', {'user': user, 'orders': orders, 'products': products})
...
def sorted_basket(request, user_id, days_ago):
    ...
    return render(request, 'mymodapp/user_all_product.html', {'user': user, 'product_set': product_set, 'days': days_ago})
